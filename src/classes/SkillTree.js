...
export const SkillTreeDefinitions = {
    ...
    archer: [
        ...
        { id: 'archer_arrow_storm', name: 'Arrow Storm', description: 'Ultimate: Rain of arrows on large area', tier: 4, levelRequired: 20, requires: ['archer_sniper', 'archer_rapid_fire'], type: 'ability', grantsAbility: { name: 'Arrow Storm', damage: 10, hits: 20, cooldown: 45, radius: 200, type: 'ultimate' } }
    ],
    ...
    ninja: [
        ...
        { id: 'ninja_ultimate_jutsu', name: 'Forbidden Jutsu', description: 'Ultimate: Massive elemental devastation', tier: 4, levelRequired: 20, requires: ['ninja_substitution', 'ninja_elemental_jutsu'], type: 'ability', grantsAbility: { name: 'Forbidden Jutsu', damage: 200, manaCost: 80, cooldown: 60, radius: 250, type: 'ultimate' } }
    ],
    ...
    samurai: [
        ...
        { id: 'samurai_final_strike', name: 'Final Strike', description: 'Ultimate: One devastating blow', tier: 4, levelRequired: 20, requires: ['samurai_thousand_cuts', 'samurai_honor'], type: 'ability', grantsAbility: { name: 'Final Strike', damage: 300, staminaCost: 80, cooldown: 45, type: 'ultimate' } }
    ],
    ...
    viking: [
        ...
        { id: 'viking_ragnarok', name: 'Ragnarok', description: 'Ultimate: Devastating AOE slam', tier: 4, levelRequired: 20, requires: ['viking_dual_wield', 'viking_war_paint'], type: 'ability', grantsAbility: { name: 'Ragnarok', damage: 150, staminaCost: 100, cooldown: 50, radius: 180, type: 'ultimate' } }
    ],
    ...
    necromancer: [
        ...
        { id: 'necro_lich', name: 'Lich Form', description: 'Ultimate: Transform into a Lich', tier: 4, levelRequired: 20, requires: ['necro_army_upgrade', 'necro_skeleton_mage'], type: 'ability', grantsAbility: { name: 'Lich Form', duration: 20, cooldown: 90, type: 'ultimate' } }
    ],
    ...
    priest: [
        ...
        { id: 'priest_divine_intervention', name: 'Divine Intervention', description: 'Ultimate: Prevent all deaths for 5s', tier: 4, levelRequired: 20, requires: ['priest_mass_heal', 'priest_smite_upgrade'], type: 'ability', grantsAbility: { name: 'Divine Intervention', duration: 5, cooldown: 120, radius: 300, type: 'ultimate' } }
    ],
    ...
    darkmage: [
        ...
        { id: 'dark_apocalypse', name: 'Apocalypse', description: 'Ultimate: Rain of dark destruction', tier: 4, levelRequired: 20, requires: ['dark_soul_rend'], type: 'ability', grantsAbility: { name: 'Apocalypse', damage: 200, manaCost: 100, cooldown: 60, radius: 300, type: 'ultimate' } }
    ],
    ...
    arcmage: [
        ...
        { id: 'arc_black_hole', name: 'Black Hole', description: 'Ultimate: Create a black hole', tier: 4, levelRequired: 20, requires: ['arc_blink', 'arc_mana_shield'], type: 'ability', grantsAbility: { name: 'Black Hole', damage: 20, manaCost: 100, cooldown: 60, duration: 6, radius: 200, type: 'ultimate' } }
    ],
    ...
    magicalknight: [
        ...
        { id: 'mk_avatar', name: 'Avatar of Magic', description: 'Ultimate: Transform into magic avatar', tier: 4, levelRequired: 20, requires: ['mk_rune_mastery'], type: 'ability', grantsAbility: { name: 'Avatar of Magic', duration: 15, cooldown: 90, type: 'ultimate' } }
    ],
    ...
    musketeer: [
        ...
        { id: 'musk_honor_duel', name: 'Honor Duel', description: 'Ultimate: Challenge boss to duel', tier: 4, levelRequired: 20, requires: ['musk_all_for_one'], type: 'ability', grantsAbility: { name: 'Honor Duel', duration: 20, cooldown: 90, type: 'ultimate' } }
    ]
};
